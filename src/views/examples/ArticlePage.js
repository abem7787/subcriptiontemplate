    ...
    content: [
      {
        ...
        text: "If you are a forward-thinker intrigued by Sci-fi- imaginative and practical steps to reduce commercial costs and improve efficiency, this real-world analogy is for you. Please bear with me. Although at first glance the pilot deployment may seem like it doesn’t suit your enterprise needs, it will benefit you in some form. How? You can learn the potential of machine learning capabilities and how it may scale within enterprise logistics. First, without overwhelming you with technical terms, let's understand the basic MVP concept integrating machine learning with a Smart App and Rapid Infrared Technology.",
      },
      {
        subtitle: "Setting the Context: A Science Experiment",
        text: "Please keep an open mind, I have no political agenda, nor intend to have one. This is purely a science experiment because I’m a bit of a nerd who loves solving real-world issues. I will later demonstrate emprical evidence that It can be done with more rigerous methods, so stay tune. What is biomass and combustion, and how do we integrate infrared hardware to detect why certain  impruites may cause failure in combustion? We will also explore how an ML model can solve this issue.",
      },
      {
